...
LET inkColor=9: LET bonus=0: LET lev=1: LET damsels=1: LET HSC=250 : LET DAMSELS=1
LET H$="IAN"
let k$=chr$ 8+chr$ 9+chr$ 11+chr$ 10:rem cursor keys

@l6:
IF damsels>2 THEN GO TO @l5700
LET paperColor=6: LET inkColor=9
LET borderColor=0: LET mines=50: LET damsels=1: LET SC=0
LET bonus=0: LET DAMSELS=1
@l10:
...
PRINT AT 0,0; PAPER 0; INK 7;"MINAS VECINAS 0";AT 0,17;"NO.";DAMSELS;" PUNT. ";SC
...
PRINT AT x,y;C$
NEXT n: IF SC=0 AND DAMSELS>2 AND BONUS=0 THEN PRINT AT 15,0;: LIST
PRINT AT 21,17; FLASH 1; PAPER 2; INK 7;"PONIENDO MINAS": IF damsels=9 THEN LET mines=mines+32: LET MINES=MINES+(10-INT (SC/1000))
PRINT AT 21,3; FLASH 1; PAPER 2; INK 7; INVERSE 1;"NIVEL ";DAMSELS
FOR w=1 TO mines: PRINT AT INT (RND*16)+3,INT (RND*30)+1; INK paperColor;"\o"
BEEP .0015,35
...
FOR m=60 TO 10 STEP -2.5: FOR n=1 TO 7: NEXT n: BEEP .125,m: NEXT m
PRINT AT 21,0;"                                "
PRINT AT 8,9;"              "
@l490:
BEEP .0875,10
...
PRINT AT 21,4; INVERSE 1;"ADELANTE!": FOR n=1 TO 20: BEEP .002,n+20: NEXT n: PRINT AT 21,4;"         ": BEEP .05,37
GO TO @l535
@l500:
LET oldx=x: LET oldy=y
@l520:
...
LET TI=TI+1
IF DAMSELS>=4 THEN IF TI>(260*PAPER+70) THEN IF INT (TI/(3*PAPER+1))=(TI/(3*PAPER+1)) THEN GO SUB @l543
...
LET I$=T$+T$: IF DAMSELS>=5 AND paperColor<>PA AND TI>2000 THEN GO SUB @l8000
...
@l800:
IF damsels>2 AND damsels<9 AND ti>50 THEN IF RND>.98 THEN GO TO @l100
GO TO @l500
STOP
...
FOR W=20 TO 1 STEP -1: BEEP .003,0+W: PRINT AT X,Y;"\c": BEEP .002,10: PRINT AT X,Y;"\o": NEXT W
LET j$=" HAS EXPLOTADO! ": IF RND>.8 THEN LET j$="  HAS VOLADO !  ": IF RND>.7 THEN LET j$="  DESTRUCCION!  "
PRINT AT 0,0; PAPER 0; INK 7;j$
BEEP 1.6,-35
GO SUB @l2000
PRINT AT X,Y; PAPER 7; INK 0; OVER 1;CHR$ (65+INT (RND*60))
BEEP 1,-35
IF SC>HSC THEN GO SUB @l4500
PRINT AT 0,28; PAPER 0;"  "
PRINT AT 0,0; PAPER 0; INK 7;" ";"OTRA VEZ  ?  NIVEL ";DAMSELS;" ";AT 0,22; FLASH 1;"PUNT. ";SC
...
FOR N=1 TO 10000000
IF SC=HSC THEN PRINT AT 21,0; PAPER borderColor; INK 9;"\d";AT 21,31;"\e"
IF INKEY$="" THEN FOR M=1 TO 16: NEXT M
IF SC=HSC THEN PRINT AT 21,0; PAPER borderColor; INK 9;"\e";AT 21,31;"\d"
IF INKEY$="" THEN FOR M=1 TO 16: NEXT M
LET s$=INKEY$
IF s$="" THEN NEXT n
IF S$="I" OR S$="i" THEN GO SUB @l7000
PRINT AT 2,1;"                              "
GO TO @l6
...
FOR m=1 TO 5: IF INKEY$="S" OR INKEY$="s" THEN GO TO @l2033:
NEXT m
@l2033:
...
BORDER borderColor
IF bonus>0 THEN LET sc=sc+bonus: PRINT AT 21,0; PAPER 7; BRIGHT 1;"BONOS INICIALES = ";BONUS: LET BONUS=0: FOR N=1 TO 20 STEP .6: BEEP .025,n+5: NEXT N: PRINT AT 21,0;"                                "
GO SUB @l2000
FOR g=4 TO 22 STEP 6: BEEP .005,g+24: NEXT g
FOR N=1 TO 80: BORDER 1: BORDER 2: BORDER 3: BORDER 4: BORDER 5: BORDER 6: NEXT N
LET SC=SC+SS
PRINT AT 0,30; PAPER 0;"  "
PRINT AT 0,0; PAPER 0; INK 7;"MINAS VECINAS 0  NO.";DAMSELS;" PUNT ";SC
FOR n=1 TO 120
NEXT n
LET MINES=MINES+10
...
@l4500:
FOR N=1 TO 50: BORDER 1: BORDER 2: BORDER 3: BORDER 4: NEXT N: IF DAMSELS=1 THEN LIST
FOR N=1 TO 50: BORDER 6: BORDER 2: BEEP .002,40+(N/10): BORDER 6: NEXT N
FOR M=1 TO 4
FOR N=7 TO 0 STEP -1
...
FOR N=1 TO 12: BEEP .0045,-10: BORDER 1: BORDER 2: BORDER 6: BORDER 4: NEXT N
BORDER bordercolor
BEEP .1,8: FOR N=1 TO 4: NEXT N: BEEP .1,8: BEEP .1,8: BEEP .1,20: BEEP .1,24: BEEP .1,18: BEEP .15,29
FOR N=1 TO 7: NEXT N: BEEP .12,22: FOR N=1 TO 3: NEXT N:: BEEP .07,19: BEEP .08,17: FOR N=1 TO 3: NEXT N: BEEP .1,14: BEEP .1,12
PRINT AT 10,7;"                  "
RETURN
...
NEXT n
INK 9: IF sc=0 AND bonus=0 THEN PRINT AT 15,0;: LIST
PRINT AT 13,13; FLASH 1;"1";AT 13,14;" A ";AT 13,18; FLASH 1;lev
PRINT AT 13,13; FLASH 1;"1"
PRINT AT 13,14;" A "
PRINT AT 13,18; FLASH 1;LEV
BEEP .1,30: FOR n=1 TO 25: NEXT n
@l5751:
...
LET ll=VAL l$
IF ll>lev OR ll<>(INT ll) OR ll<1 THEN BEEP 1,-15: GO TO @l5700
LET sc=0
LET damsels=ll
...
PRINT AT 21,17; INVERSE 1;"PULSA UNA TECLA"
FOR N=1 TO 40: NEXT N: FOR N=1 TO 50000: IF INKEY$="" THEN NEXT N
RESTORE @l9980: FOR N=1 TO 47: READ I: READ L:
...
LET j$="                                 \a        \h                                        "
FOR n=1 TO LEN j$-35: PRINT AT 6,0;j$(n TO n+31): BEEP .0018,60: FOR m=1 TO 1: NEXT m: NEXT n
...
PRINT AT 0,0; PAPER (4-O); INK 9;"MINAS VECINAS ";O
IF o THEN BEEP .04,o*10
FOR M=1 TO 22: NEXT M: PRINT AT 6+O,14;" ": NEXT O: NEXT N
...
IF s$="I" OR s$="i" THEN GO TO @l7000
CLS
RETURN
...
BEEP .05,N-10: IF damsels<=8 OR n>14 THEN PRINT AT N,1; OVER 1; INK PAPER; PAPER PAPER;"                              "
PRINT AT X,Y; PAPER PA;C$
NEXT N
...
RETURN
@l8444:
GO SUB @l9300: LET DX=30: FOR u=.155 TO .005 STEP -.01: IF damsels<>9 OR x<>8 THEN PRINT AT 15,0;: LIST
...
PRINT AT 0,0; PAPER 7;" ": FOR t=0 TO 2
FOR l=0 TO 7 STEP 7: INK l
GO SUB @l8450: GO TO @l8700
...
FOR n=1 TO 14: BEEP .002,50-n+b: BORDER 1: BORDER 2: BORDER 3: BORDER 4: BORDER 5: BORDER 6: BORDER 7: BORDER b: NEXT n
NEXT b
BORDER 6: PAPER paperColor: INK 9
BORDER 0: PAPER 0: CLS
FOR n=0 TO 30 STEP 6: FOR m=1 TO 10
BEEP .008,n+m: NEXT m: NEXT n
PRINT AT 3,8;"  FELICIDADES  ";'';" HAS RESCATADO A BILL. EL MUN-   DO TE ESTA AGRADECIDO.         "
PRINT ''''';" TUS PUNTOS = ";SC;", QUE NO ESTA"'" NADA MAL ...  PORQUE NO VUELVES A JUGAR Y TRATAS DE MEJORAR TU          PUNTUACION ?"
IF SC>HSC THEN GO SUB @l4500
...
FOR A=1 TO 16: READ A$: FOR B=0 TO 7: READ C: POKE USR A$+B,C: NEXT B: BEEP .012,40: NEXT A
