...
@l6 IF damsels>2 THEN GO TO 5700
   7 LET paperColor=6: LET inkColor=9
   8 LET borderColor=0: LET mines=50: LET damsels=1: LET SC=0
   9 LET bonus=0: LET DAMSELS=1
@l10 LET inkColor=9: BORDER borderColor: PAPER paperColor: INK inkColor: CLS : BORDER borderColor
...
@l300 PRINT AT 0,28; PAPER 0;"    "
 ...
 438 NEXT W
@l439 IF lev<>1 THEN PRINT AT 15,0;: LIST
...
@l450 LET CC=INT (RND*12)+4: LET DD=INT (RND*6)+6: LET EE=INT (RND*6)+19
 452 FOR J=1 TO 7
 ...
 471 BEEP .002,58
 475 NEXT J
@l480 IF damsels<>8 THEN GO TO 490
...
@l520 LET x=x+(INKEY$=k$(4))-(INKEY$=k$(3))
 521 LET x=x-(x=22)
 ...
 532 BEEP .003,-4
@l535 PRINT AT oldx,oldy; PAPER PA;" "
...
@l550 PRINT AT x,y; PAPER PA;C$
@l570 LET o=(SCREEN$ (x-1,y)<>" ")
...
1190 INK 9
@l1200 PRINT AT 21,29; PAPER borderColor; INK 9;"   ";AT 21,0; PAPER borderColor; INK 9;" PUNTUACION MAX.= ";HSC;" POR ";H$
...
@l5751 LET l$=INKEY$: IF l$="" THEN GO TO 5751
...
@l7060 IF INKEY$="" THEN GO TO 7060
7065 PAPER 7: INK 0
7070 CLS
7075 RETURN
...
@l7390 LET s$=INKEY$: IF s$="" THEN GO TO 7390
...
8018 PRINT AT 21,0;"                                "
8020 RETURN
@l8444 GO SUB 9300: LET DX=30: FOR u=.155 TO .005 STEP -.01: IF damsels<>9 OR x<>8 THEN PRINT AT 15,0;: LIST
...
9092 BEEP .1 ,23
@l9095 LET s$=INKEY$: IF s$="" THEN GO TO 9095
