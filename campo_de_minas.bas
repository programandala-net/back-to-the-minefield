...
IF lev<>1 THEN PRINT AT 15,0;: LIST
 ...
 446 IF damsels=9 THEN GO SUB @l9900: GO TO @l480
...
LET x=x+(INKEY$=k$(4))-(INKEY$=k$(3))
 ...
 526 LET TI=TI+1
 528 IF DAMSELS>=4 THEN IF TI>(260*PAPER+70) THEN IF INT (TI/(3*PAPER+1))=(TI/(3*PAPER+1)) THEN GO SUB @l543
 530 IF oldx=x AND oldy=y THEN GO TO @l520
 532 BEEP .003,-4
@l535:
PRINT AT oldx,oldy; PAPER PA;" "
 537 LET t$=t$+CHR$ (x+65)+CHR$ (y+65)
 540 IF SCREEN$ (x,y)<>" " THEN GO SUB @l1000
 541 IF damsels=9 AND pa<>paperColor AND x<17 THEN GO SUB @l8000
 542 GO TO @l550
...
PRINT AT OO,PP; PAPER PA;" "
 544 LET I$=T$+T$: IF DAMSELS>=5 AND paperColor<>PA AND TI>2000 THEN GO SUB @l8000
 545 LET RR=RR+2: BEEP .0018,60
 546 LET OO=65-CODE I$(RR): LET PP=65-CODE I$(RR+1)
 547 IF SCREEN$ (OO,PP)<>" " THEN GO SUB @l1000
...
1022 BEEP 1,-35
1023 IF SC>HSC THEN GO SUB @l4500
...
1610 IF S$="I" OR S$="i" THEN GO SUB @l7000
1620 PRINT AT 2,1;"                              "
1650 GO TO @l6
...
8950 IF SC>HSC THEN GO SUB @l4500
...
9098 IF s$="i" OR s$="I" THEN GO SUB @l7000
9100 RUN
